...
const calcDisplaySummary = function (acc) {
  ...
  // labelSumIn.textContent = `${Number(incomes).toFixed(2)}€`;
...
// Number, Dates, Intl and Timers (Prjojects)
...
//  converted string to number at two way
...
console.log(4838430862435746345801735428974525785438253120n);
console.log(BigInt(4838430862435746345801735428974525785438253120n));

// Operations
console.log(10000n + 10000n);
console.log(362863726372637263762372637538925332n * 10000000n);
// console.log(Math.sqrt(16n));
const huge = 20289830237886395473589837n;
const num = 23;
...
console.log(new Date("Dec 08 2025 13:39:42"));
